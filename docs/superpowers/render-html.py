#!/usr/bin/env python3
"""Render Acme spec/plan markdown files to standalone HTML.

Outputs alongside each .md: <basename>.html — self-contained, no CDN runtime,
just Google Fonts via @import for typography. Style aligns with the Acme
...
<div class="layout">
  <aside class="toc">
    <div class="toc-eyebrow">Acme Account Management</div>
