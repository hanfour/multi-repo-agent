...
for good in "acme-api" "user_service" "v0.5" "Alpha123" "a"; do
...
resolved=$(resolve_project_dir "$WS" "acme-api" 2>/dev/null)
expected=$(cd "$WS/acme-api" && pwd -P)
