...
if [[ "$output" != *"interface"* ]]; then echo "FAIL: should detect interface"; errors=$((errors+1)); fi
if [[ "$output" != *"enum"* ]]; then echo "FAIL: should detect enum"; errors=$((errors+1)); fi
if [[ "$output" != *"any"* ]]; then echo "FAIL: should detect any"; errors=$((errors+1)); fi
if [[ "$output" != *"violation"* ]]; then echo "FAIL: should report violations"; errors=$((errors+1)); fi
...
if [[ "$output" != *"no violations"* ]]; then echo "FAIL: clean file should have no violations"; errors=$((errors+1)); fi
...
if [[ "$output" != *"skipping"* ]]; then echo "FAIL: rails should be skipped"; errors=$((errors+1)); fi
